...
if (
  __DEV__ &&
  Object.values(translationGetters).some(
    (x) =>
      stringifyKeys(x) !== stringifyKeys(translationGetters[defaultLocale]),
  )
) {
...
I18n.missingTranslation = (key) =>
  __DEV__ && alert('missing translation: ' + key);
...
const findBestAvailableLanguage = () => {
  ...
  return Object.keys(translationGetters).includes(lang) ? lang : defaultLocale;
};
